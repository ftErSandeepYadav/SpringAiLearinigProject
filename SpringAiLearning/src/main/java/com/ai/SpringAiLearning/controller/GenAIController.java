...
public class GenAIController {
    ...
    public List<String> generatImages(HttpServletResponse response, @RequestParam String promt) throws IOException {
        ImageResponse imageResponse = imageService.generateImage(promt) ;
